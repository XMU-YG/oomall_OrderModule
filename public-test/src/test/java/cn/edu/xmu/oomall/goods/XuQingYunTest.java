...
//        String expectedResponse="{\"errno\":0,\"data\":{\"id\":273,\"goodsSpuId\":273,\"name\":\"+\",\"skuSn\":null,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"inventory\":1,\"originalPrice\":980000,\"configuration\":null,\"weight\":10,\"detail\":null,\"disabled\":4,\"gmtCreated\":\"2020-11-28T17:42:17\",\"gmtModified\":\"2020-11-28T17:42:17\",\"goodsSkuPo\":{\"id\":273,\"goodsSpuId\":null,\"skuSn\":null,\"name\":\"+\",\"originalPrice\":980000,\"configuration\":null,\"weight\":10,\"imageUrl\":null,\"inventory\":1,\"detail\":null,\"disabled\":null,\"gmtCreate\":null,\"gmtModified\":null}},\"errmsg\":\"成功\"}";
    ...
    void deleteSku() throws Exception{
        ...
        byte[] response =manageClient.delete().uri("/shops/1/skus/273").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response =manageClient.delete().uri("/shops/0/skus/273").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
    ...
    void modifySKU() throws Exception{
        ...
        byte[] response =manageClient.put().uri("/shops/0/skus/683")
    ...
    {
        String token = this.login("13088admin", "123456");
        byte[] response  = manageClient.get().uri("/share/0/skus/273")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.get().uri("/share/0/skus/273")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.get().uri("/share/0/skus/274")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void putGoodsOnSale() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] response  = manageClient.put().uri("/shops/0/skus/683/onshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.put().uri("/shops/0/skus/683/onshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.put().uri("/shops/1/skus/683/onshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void putOffGoodsOnSale() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] response  = manageClient.put().uri("/shops/0/skus/683/offshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.put().uri("/shops/0/skus/683/offshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        response  = manageClient.put().uri("/shops/1/skus/683/offshelves")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
