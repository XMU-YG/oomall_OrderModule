...
public class ChenYixinTest {
    ...
    public void shopsShopIdOrdersGet0() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
    ...
    public void shopsShopIdOrdersGet1() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders?page=1&pageSize=3").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .jsonPath("$.errmsg").isEqualTo(ResponseCode.OK.getMessage())
    ...
    public void shopsShopIdOrdersGet2() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders?customerId=2&page=1&pageSize=3").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .jsonPath("$.errmsg").isEqualTo(ResponseCode.OK.getMessage())
    ...
    public void shopsShopIdOrdersGet3() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders?orderSn=2016102363333").header("authorization",token).exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .jsonPath("$.errmsg").isEqualTo(ResponseCode.OK.getMessage())
        ...
        String expectedResponse="{\"errno\":0,\"data\":{\"total\":1,\"pages\":1,\"pageSize\":10,\"page\":1,\"list\":[{\"id\":48052,\"customerId\":1,\"shopId\":1,\"pid\":null,\"orderType\":null,\"state\":2,\"subState\":21,\"gmtCreateTime\":\"2020-11-28T17:48:46\",\"originPrice\":null,\"discountPrice\":null,\"freightPrice\":null}]},\"errmsg\":\"成功\"}";
    ...
    public void shopsShopIdOrdersIdGet1() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders/4000000").header("authorization",token).exchange()
                .expectStatus().isNotFound()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_NOTEXIST.getCode())
                .jsonPath("$.errmsg").isEqualTo("查询的订单id不存在")
                .returnResult()
                .getResponseBodyContent();
    ...
    public void shopsShopIdOrdersIdGet2() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders/1").header("authorization",token).exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_OUTSCOPE.getCode())
                .jsonPath("$.errmsg").isEqualTo("查询的订单id不是本店铺的")
                .returnResult()
                .getResponseBodyContent();

        String expectedResponse="{\"errno\":505,\"errmsg\":\"查询的订单id不是本店铺的\"}";
    ...
    public void shopsShopIdOrdersIdPut1() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/1/orders/4000000")
                ...
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_NOTEXIST.getCode())
                .jsonPath("$.errmsg").isEqualTo("修改的订单id不存在")
                .returnResult()
                .getResponseBodyContent();

        String expectedResponse = "{\"errno\":504,\"errmsg\":\"修改的订单id不存在\"}";
    ...
    public void shopsShopIdOrdersIdPut2() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("/shops/1/orders/1")
                ...
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_OUTSCOPE.getCode())
                .jsonPath("$.errmsg").isEqualTo("修改的订单id不是本店铺的")
                .returnResult()
                .getResponseBodyContent();

        String expectedResponse = "{\"errno\":505,\"errmsg\":\"修改的订单id不是本店铺的\"}";
    ...
    public void postFreights0() throws Exception {
        ...
        String expectedConResponse = "{data:{id:48052,freightSn:test}}";
    ...
    public void shopsShopIdOrdersIdDelete0() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48050")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete1() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48051")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/1/orders/48051")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete2() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/4000000")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_NOTEXIST.getCode())
                .jsonPath("$.errmsg").isEqualTo("取消的订单id不存在")
                .returnResult()
                .getResponseBodyContent();

        String expectedResponse = "{\"errno\":505,\"errmsg\":\"取消的订单id不存在\"}";
        JSONAssert.assertEquals(expectedResponse, new String(responseString, StandardCharsets.UTF_8), false);
    }
    ...
    public void shopsShopIdOrdersIdDelete3() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/1")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_OUTSCOPE.getCode())
                .jsonPath("$.errmsg").isEqualTo("取消的订单id不是本店铺的")
                .returnResult()
                .getResponseBodyContent();
    ...
    public void shopsShopIdOrdersIdDelete4() throws Exception {
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48052")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        String expectedConResponse = "{data:{id:48052,state:4}}";
    ...
    public void shopsShopIdOrdersIdDelete5() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48053")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/1/orders/48053")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete6() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48054")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] confirmString = mallClient.get().uri("/shops/1/orders/48054")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete7() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48055")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete8() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48056")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersIdDelete9() throws Exception {
        ...
        String token=this.login("537300010","123456");
        byte[] responseString = mallClient.delete().uri("/shops/1/orders/48057")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void shopsShopIdOrdersGetNotLogin() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders").header("authorization",token).exchange()
                ...
                .jsonPath("$.errmsg").isEqualTo("JWT不合法")
                .returnResult()
                .getResponseBodyContent();
    ...
    public void shopsShopIdOrdersIdGetNotLogin() throws Exception {
        ...
        byte[] responseString=manageClient.get().uri("/shops/1/orders/48050").header("authorization",token).exchange()
                .expectStatus().isUnauthorized()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.AUTH_INVALID_JWT.getCode())
                .jsonPath("$.errmsg").isEqualTo("JWT不合法")
    ...
    @Test
    @Order(36)
    public void getorderStateNotLogin() throws Exception {
        String token="test";
