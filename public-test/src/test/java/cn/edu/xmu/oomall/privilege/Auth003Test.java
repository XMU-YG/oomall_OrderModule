...
public class Auth003Test {
    ...
    private String login(String userName, String password) throws Exception{
        ...
        byte[] ret = webClient.post().uri("/privilege/privileges/login").bodyValue(requireJson).exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void findAllUsers1() throws Exception {
        ...
        String response = new String(Objects.requireNonNull(webClient
                .get()
                .uri("/privilege/shops/0/adminusers/all?userName=&mobile=&page=2&pagesize=3")
        ...
        JSONAssert.assertEquals(expectOutput, response, true);
    }
    ...
    public void findAllUsers2() throws Exception {
        ...
        String response = new String(Objects.requireNonNull(webClient
                .get()
                .uri("/privilege/shops/0/adminusers/all?userName=&mobile=&page=1&pagesize=-2")
                .header("authorization", token)
                .exchange()
                .expectHeader()
                .contentType("application/json;charset=UTF-8")
    ...
    public void findUserById1() throws Exception {
        ...
        String response = new String(Objects.requireNonNull(webClient
                .get()
                .uri("/privilege/shops/0/adminusers/46")
                .header("authorization", token)
                .exchange()
                .expectHeader()
                .contentType("application/json;charset=UTF-8")
    ...
    public void findUserById2() throws Exception {
        ...
        String response = new String(Objects.requireNonNull(webClient
                .get()
                .uri("/privilege/shops/0/adminusers/23")
                .header("authorization", token)
                .exchange()
                .expectHeader()
                .contentType("application/json;charset=UTF-8")
