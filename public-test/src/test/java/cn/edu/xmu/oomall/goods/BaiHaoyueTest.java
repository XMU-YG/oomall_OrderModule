...
public class BaiHaoyueTest {
    ...
    public void getunderline1() throws Exception {
        ...
        byte[] queryResponseString = mallClient.get().uri("/shops/2/couponactivities/invalid").header("authorization",token)
                .exchange()
    ...
    public void getunderline2() throws Exception {
        String token = this.login("13088admin","123456");
        byte[] queryResponseString = mallClient.get().uri("/shops/0/couponactivities/invalid").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .returnResult()
    ...
    public void getunderline3() throws Exception {
        String token = this.login("13088admin","123456");
        byte[] queryResponseString = mallClient.get().uri((uriBuilder -> uriBuilder.path("/shops/0/couponactivities/invalid")
                .queryParam("page",2)
    ...
    public void createCouponActivity1() throws Exception {
        ...
        String json="{\n" +
                ...
                "  \"validTerm\": 0\n" +
                "}";
        byte[] responseString1 = mallClient.post().uri("/shops/2/couponactivities")
    ...
    public void createCouponActivity2() throws Exception {
        ...
        String json="{\n" +
                ...
                "  \"validTerm\": 0\n" +
                "}";
        byte[] responseString = mallClient.post().uri("/shops/0/couponactivities")
                .header("authorization",token1)
                .bodyValue(json)
                .exchange()
                .expectStatus().isOk()
        ...
        String expectedResponse =   "{\n" +
                ...
                "    \"id\": 10,\n" +
                "    \"name\": \"string\",\n" +
                "    \"beginTime\": \"2022-12-15T07:05:33.976\",\n" +
                "    \"endTime\": \"2023-12-15T07:05:33.976\",\n" +
                "    \"couponTime\": \"2022-12-15T07:05:33.976\",\n" +
                "    \"state\": 0,\n" +
                "    \"shopId\": 0,\n" +
                "    \"quantity\": 0,\n" +
                "    \"validTerm\": 0,\n" +
    ...
    public void modifyCouponActivity1() throws Exception {
        ...
        String json="{\n" +
                ...
                "  \"strategy\": \"string\"\n" +
                "}";
        byte[] responseString = mallClient.put().uri("/shops/2/couponactivities/10")
                .header("authorization",token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isForbidden()
    ...
    public void modifyCouponActivity2() throws Exception {
        ...
        String json="{\n" +
                ...
                "  \"strategy\": \"string\"\n" +
                "}";
        byte[] responseString = mallClient.put().uri("/shops/0/couponactivities/7")
                .header("authorization",token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isForbidden()
    ...
    public void modifyCouponActivity3() throws Exception {
        ...
        String json="{\n" +
                ...
                "  \"strategy\": \"string\"\n" +
                "}";
        byte[] responseString1 = mallClient.put().uri("/shops/0/couponactivities/9")
                .header("authorization",token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isOk()
        ...
        byte[] responseString2 = mallClient.get().uri("/shops/0/couponactivities/9")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
  ...
  //              "    \"gmtModified\": \"2020-12-13T08:14:54\",\n" +
    ...
    public void onshelves6() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "}";
        JSONAssert.assertEquals(expectedResponse, responseString, true);
        byte[] responseString2 = mallClient.get().uri("/shops/0/couponactivities/4")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
...
//        String responseString1 = new String(ret, "UTF-8");
    ...
    public void delete6() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "}";
        JSONAssert.assertEquals(expectedResponse, responseString, true);
        byte[] responseString2 = mallClient.get().uri("/shops/0/couponactivities/1")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
...
//        String responseString1 = new String(ret, "UTF-8");
    ...
    public void getdetail1() throws Exception {
        String token = this.login("13088admin","123456");
        byte[] queryResponseString = mallClient.get().uri("/shops/0/couponactivities/0")
                .header("authorization",token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void getdetail2() throws Exception {
        String token = this.login("13088admin","123456");
        byte[] queryResponseString = mallClient.get().uri("/shops/0/couponactivities/7")
                .header("authorization",token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
    ...
    public void getdetail3() throws Exception {
        String token = this.login("13088admin","123456");
        byte[] queryResponseString = mallClient.get().uri("/shops/0/couponactivities/6")
                .header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
