...
public class ChenPinzhenTest {
    ...
    public void getSpuByIdTest1() throws Exception {
        ...
        String expectedResponse = "{\"errno\":0,\"data\":{\"id\":20680,\"name\":\"cpz1\",\"brand\":{\"id\":120,\"name\":\"cpz1\",\"imageUrl\":null},\"category\":{\"id\":20140,\"name\":\"cpz1\"},\"freight\":null,\"shop\":null,\"goodsSn\":\"drh-d0001\",\"detail\":null,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-09T22:36:01\",\"gmtModified\":\"2020-12-09T22:36:01\",\"disable\":0,\"skuList\":[{\"id\":20680,\"skuSn\":null,\"name\":\"cpz1\",\"originalPrice\":980000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"inventory\":1,\"disable\":false,\"price\":980000}]},\"errmsg\":\"成功\"}";
    ...
    public void insertSpu1() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "    \"state\": null,\n" +
                "    \"spec\": null,\n" +
                "    \"gmtCreate\": \"2020-12-16T01:01:32.9331874\",\n" +
                "    \"gmtModified\": null,\n" +
                "    \"disable\": null,\n" +
                "    \"skuList\": null\n" +
                "  },\n" +
        ...
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/" + id)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse1 = "{\"errno\":0,\"data\":{\"id\":20684,\"name\":\"test\",\"brand\":null,\"category\":null,\"freight\":null,\"shop\":{\"id\":20001,\"name\":\"cpz1\"},\"goodsSn\":null,\"detail\":\"test\",\"imageUrl\":null,\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-16T01:01:32\",\"gmtModified\":null,\"disable\":null,\"skuList\":[]},\"errmsg\":\"成功\"}";
    ...
    public void updateSpu1() throws Exception {
        ...
        byte[] ret = manageClient.put()
                .uri("/goods/shops/20001/spus/20684")
                .header("authorization", token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isOk()
        ...
        String expectedResponse = "{\n" +
                ...
                "}";
        JSONAssert.assertEquals(expectedResponse, responseString, true);
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20684")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse1 = "{\"errno\":0,\"data\":{\"id\":20684,\"name\":\"string\",\"brand\":null,\"category\":null,\"freight\":null,\"shop\":{\"id\":1,\"name\":\"cpz1\"},\"goodsSn\":null,\"detail\":\"string\",\"imageUrl\":null,\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-16T01:01:32\",\"gmtModified\":null,\"disable\":null,\"skuList\":[]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectedResponse1, new String(queryResponseString, "UTF-8"), false);
    }
    ...
    public void deleteSpu1() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "}";
        JSONAssert.assertEquals(expectedResponse, responseString, true);
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20680")
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.RESOURCE_ID_NOTEXIST.getCode())
    ...
    public void onshelfSku1() throws Exception {
        ...
        int endIndex = responseString.indexOf("name");
        String id = responseString.substring(startIndex, endIndex);
        byte[] queryResponseString = mallClient.get().uri("/goods/skus/" + id)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
    ...
    public void insertFloatPrice1() throws Exception {
        ...
        String json = "{\n" +
                "  \"activityPrice\": 10,\n" +
                "  \"beginTime\": \"2021-12-14T03:00:52.991Z\",\n" +
                "  \"endTime\": \"2021-12-24T03:00:52.991Z\",\n" +
                "  \"quantity\": 10\n" +
                "}";
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/skus/273/floatPrices")
                .header("authorization", token)
                .bodyValue(json)
                .exchange()
                .expectStatus().isOk()
    ...
    public void insertFloatPrice2() throws Exception {
        ...
        String json = "{\n" +
                "  \"activityPrice\": 10,\n" +
                "  \"beginTime\": \"2020-11-14T02:23:01.036Z\",\n" +
                "  \"endTime\": \"2020-12-14T02:23:01.036Z\",\n" +
                "  \"quantity\": 10\n" +
                "}";
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/skus/273/floatPrices")
                ...
                .jsonPath("$.errmsg").isEqualTo(ResponseCode.SKUPRICE_CONFLICT.getMessage())
                .returnResult()
                .getResponseBodyContent();
        String responseString = new String(ret, "UTF-8");
        String expectedResponse = "{\n" +
    ...
    public void deleteFloatPrice1() throws Exception {
        ...
        byte[] ret = manageClient.delete()
                .uri("/goods/shops/0/floatPrices/20001")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
...
//        String token = this.login("13088admin", "123456");
//        byte[] ret = manageClient.delete()
//                .uri("/goods/shops/0/floatPrices/20004")
//                .header("authorization", token)
//                .exchange()
//                .expectStatus().isForbidden()
//                .expectBody()
...
//    }
    ...
    public void deleteFloatPrice3() throws Exception {
        byte[] ret = mallClient.get()
                .uri("/goods/shops/0/floatPrices/20010")
                .exchange()
    ...
    public void insertSpuToBrand1() throws Exception {
        String token = this.login("537300010", "123456");
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/spus/20680/brands/20121")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20680")
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse1 = "{\"errno\":0,\"data\":{\"id\":20680,\"name\":\"cpz1\",\"brand\":{\"id\":20121,\"name\":\"cpz2\",\"imageUrl\":null},\"category\":{\"id\":140,\"name\":\"cpz1\"},\"freight\":null,\"shop\":null,\"goodsSn\":\"drh-d0001\",\"detail\":null,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-09T14:36:01\",\"gmtModified\":\"2020-12-09T14:36:01\",\"disable\":0,\"skuList\":[{\"id\":680,\"skuSn\":null,\"name\":\"cpz1\",\"originalPrice\":980000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"inventory\":1,\"disable\":false,\"price\":980000}]},\"errmsg\":\"成功\"}";
    ...
    public void insertSpuToBrand2() throws Exception {
        String token = this.login("537300010", "123456");
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/spus/20680/brands/100001")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
        ...
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20680")
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse1 = "{\"errno\":0,\"data\":{\"id\":20680,\"name\":\"cpz1\",\"brand\":{\"id\":20120,\"name\":\"cpz1\",\"imageUrl\":null},\"category\":{\"id\":140,\"name\":\"cpz1\"},\"freight\":null,\"shop\":null,\"goodsSn\":\"drh-d0001\",\"detail\":null,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-09T14:36:01\",\"gmtModified\":\"2020-12-09T14:36:01\",\"disable\":0,\"skuList\":[{\"id\":20680,\"skuSn\":null,\"name\":\"cpz1\",\"originalPrice\":980000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"inventory\":1,\"disable\":false,\"price\":980000}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectedResponse1, new String(queryResponseString, "UTF-8"), true);
    }
    ...
    public void deleteSpuFromBrand1() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = manageClient.delete()
                .uri("/goods/shops/0/spus/20680/brands/20120")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void deleteSpuFromBrand2() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = manageClient.delete()
                .uri("/goods/shops/0/spus/20680/brands/20130")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void insertSpuToCategory1() throws Exception {
        String token = this.login("537300010", "123456");
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/spus/20680/categories/20141")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20680")
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse1 = "{\"errno\":0,\"data\":{\"id\":20680,\"name\":\"cpz1\",\"brand\":{\"id\":120,\"name\":\"cpz1\",\"imageUrl\":null},\"category\":{\"id\":20141,\"name\":\"cpz2\"},\"freight\":null,\"shop\":{\"id\":0,\"name\":null},\"goodsSn\":\"drh-d0001\",\"detail\":null,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"state\":null,\"spec\":null,\"gmtCreate\":\"2020-12-08T22:36:01\",\"gmtModified\":\"2020-12-08T22:36:01\",\"disable\":0,\"skuList\":[{\"id\":20680,\"skuSn\":null,\"name\":\"cpz1\",\"originalPrice\":980000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_586206d4c7d2f.jpg\",\"inventory\":1,\"disable\":false,\"price\":980000}]},\"errmsg\":\"成功\"}";
        JSONAssert.assertEquals(expectedResponse1, new String(queryResponseString, "UTF-8"), true);
    }
    ...
    public void insertSpuToCategory2() throws Exception {
        String token = this.login("537300010", "123456");
        byte[] ret = manageClient.post()
                .uri("/goods/shops/0/spus/20680/categories/1001")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void deleteSpuFromCategory1() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = manageClient.delete()
                .uri("/goods/shops/0/spus/20680/categories/20140")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getCouponList1() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.get()
                .uri("/goods/coupons?page=1&pageSize=3&state=4")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getCouponList2() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.get()
                .uri("/goods/coupons?page=5&pageSize=3&state=4")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void receiveCoupon1() throws Exception {
        ...
        byte[] ret = mallClient.post()
                .uri("/goods/couponactivities/20003/usercoupons")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void receiveCoupon2() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.post()
                .uri("/goods/couponactivities/20001/usercoupons")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
    ...
    public void receiveCoupon3() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.post()
                .uri("/goods/couponactivities/4/usercoupons")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
    ...
    public void receiveCoupon4() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.post()
                .uri("/goods/couponactivities/20005/usercoupons")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
    ...
    public void receiveCoupon5() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = mallClient.post()
                .uri("/goods/couponactivities/20006/usercoupons")
                .header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
