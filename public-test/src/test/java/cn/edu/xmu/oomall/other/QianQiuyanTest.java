...
public class QianQiuyanTest {
    ...
    public void getAllStateTest() throws Exception {
        ...
        byte[] responseString = mallClient.get().uri("/aftersales/states").header("authorization",token).exchange()
                .expectStatus().isOk()
    ...
    public void postUserAftersales1() throws Exception{
        ...
        byte[] responseString = mallClient.post().uri("/orderItems/1/aftersales").header("authorization", token)
                ...
                .returnResult()
                .getResponseBodyContent();
        String expectedResponse = "{\"errno\":0,\"data\":{\"orderItemId\":1,\"customerId\":1,\"type\":\"换货\",\"reason\":\"testR\",\"quantity\":5,\"regionId\":1,\"detail\":\"testD\",\"consignee\":\"testC\",\"mobile\":\"13912345678\"},\"errmsg\":\"成功\"}";
...
//        body.put("regionId",(long)1);
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/aftersales/1").header("authorization", token)
...
//        body.put("regionId",(long)1);
    ...
    public void adminAgreeAftersales1() throws Exception{
        ...
        body.put("type",0);
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/100/confirm").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
        ...
        responseString = mallClient.get().uri("/shops/1/aftersales/100").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
...
//        JSONAssert.assertEquals(expectedResponse, new String(responseString, "UTF-8"), false);
    ...
    public void adminAgreeAftersales2() throws Exception{
        ...
        body.put("type",0);
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/101/confirm").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
...
//        body.put("logSn","87654321");
    ...
    public void adminAcceptExchange1() throws Exception{
        ...
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/103/receive").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
        ...
        responseString = mallClient.get().uri("/shops/1/aftersales/103").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
        ...
        responseString = mallClient.put().uri("/shops/1/aftersales/103/receive").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
...
//        body.put("conclusion","收到换货");
    ...
    public void adminAcceptRefund1() throws Exception{
        ...
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/104/receive").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
        ...
        responseString = mallClient.get().uri("/shops/1/aftersales/104").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
        ...
        responseString = mallClient.put().uri("/shops/1/aftersales/104/receive").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
...
//        body.put("conclusion","收到退款");
    ...
    public void adminUnacceptRefund1() throws Exception{
        ...
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/105/receive").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
        ...
        responseString = mallClient.get().uri("/shops/1/aftersales/105").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void adminDeliver() throws Exception{
        ...
        String requireJson = body.toJSONString();
        byte[] responseString = mallClient.put().uri("/shops/1/aftersales/106/deliver").header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
        ...
        responseString = mallClient.get().uri("/shops/1/aftersales/106").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    /**
     * 测试买家删除 删除成功 再次查询bedeleted字段 再次删除则失败 36
     * @author  24320182203253 钱秋妍
    ...
    public void userDelete1() throws Exception{
        ...
        responseString = mallClient.get().uri("/aftersales/109").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
                .jsonPath("$..beDeleted").isEqualTo(1)
                .returnResult().getResponseBodyContent();
    ...
    public void userDelete2() throws Exception{
        ...
        responseString = mallClient.get().uri("/aftersales/110").header("authorization",token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    /**
     * 买家取消或删除售后订单 失败 用户未登录 41
     * @author  24320182203253 钱秋妍
     * @date  Created in 2020/12/14 上午2:45
     */
    @Test
    public void UserDeleteAftersales4() throws Exception{
        byte[] responseString = mallClient.delete().uri("/aftersales/1")
                .exchange()
    ...
    public void AdminGetAftersales1()throws Exception{
        String token = adminLogin("13088admin","123456");
        byte[] responseString = mallClient.get().uri("/shops/0/aftersales/6343256").header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    /**
     * 管理员根据id查询售后单信息 未登录 43
     * @author  24320182203253 钱秋妍
     * @date  Created in 2020/12/14 上午2:51
     */
    @Test
    public void AdminGetAftersales3()throws Exception{
        byte[] responseString = mallClient.get().uri("/shops/0/aftersales/1")
                .exchange()
                .expectStatus().isUnauthorized()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void AdminConfirmAftersales1()throws Exception{
        String token = adminLogin("13088admin","123456");
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/563233253/confirm").header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
     ...
     * 管理员同意 未登录 45
     * @author  24320182203253 钱秋妍
     * @date  Created in 2020/12/14 上午2:58
     */
    @Test
    public void AdminConfirmAftersales2()throws Exception{
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/4/confirm")
                .exchange()
                .expectStatus().isUnauthorized()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void AdminReceiveAftersales1()throws Exception{
        String token = adminLogin("13088admin","123456");
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/563233553/receive").header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
     ...
     * 管理员确认收到 未登录 47
     * @author  24320182203253 钱秋妍
     * @date  Created in 2020/12/14 上午2:59
     */
    @Test
    public void AdminReceiveAftersales2()throws Exception{
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/2/receive")
                .exchange()
                .expectStatus().isUnauthorized()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void AdminDeliverAftersales1()throws Exception{
        String token = adminLogin("13088admin","123456");
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/563257253/deliver").header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
     ...
     */
    @Test
    public void AdminDeliverAftersales2()throws Exception{
        byte[] responseString = mallClient.put().uri("/shops/0/aftersales/5/deliver")
                .exchange()
                .expectStatus().isUnauthorized()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
