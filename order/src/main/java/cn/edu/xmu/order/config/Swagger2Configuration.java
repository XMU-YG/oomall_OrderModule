...
public class  Swagger2Configuration {
    ...
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "cn.edu.xmu.order.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                //创建人
                .contact(new Contact("Gang Ye", "http://software.xmu.edu.cn", "1725993571@qq.com"))
                //版本号
                .version("1.0")
                //license
