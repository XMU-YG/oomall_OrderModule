...
//     * @return  1:退款成功   -2:预售订单支付有问题  -3:找不到尾款支付
//     */
...
//
//        Long paymentId;
//        if(firstPay==restPrice)
//            paymentId=firstPayId;
//        else if(nextPay==restPrice)
//            paymentId=nextPayId;
//        else
//            return -3;
//
...
//     * @param pid
//     * @param amount
//     * @return 1退款成功  0退款金额大于支付金额  -1订单不是团购订单  -2订单未支付
//     */
...
//
//        //退款金额大于支付金额
//        if(amount>paymentPos.get(0).getAmount()){
//            return 0;
//        }
//
